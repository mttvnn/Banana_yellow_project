...
%Import the following variables to the workspace
load('range_1.mat');load('TotAct_control.mat'); load('TotAct_fallers.mat');
TotalAct=[tot;tot_fl];
Datos.range=range_1;
...
save('ResultsClassificator.mat','Results3');
